...
const StudentlistAttendance = ({navigation}) => {
    ...
    const renderItem = ({ item }) => (
        <View style={styles.item}>
            ...
            <TouchableOpacity style={styles.updateButton}
                onPress={() => navigation.navigate('OfferAttendance', {courseId: item.id})} >
                <Text style={styles.deleteButtonText}>Attendance</Text>
            </TouchableOpacity>
            </View>
            </View>
    );
...
export default StudentlistAttendance;
